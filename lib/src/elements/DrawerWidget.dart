...
import 'package:markets/new/widgets/SizedBoxWidget.dart';
        ...
        children: [
          ...
          currentUser.value.apiToken != null
              ? Padding(
                ...
                Texts(title: currentUser.value.name,fSize: 17,color: mainColor,),
                Box(10),
                Texts(title: currentUser.value.email,fSize: 14,),
              Box(10),
             Divider()
            ...
            onTap: (){
                ...
                pushPage(context: context,page: LoginWidget());
            },
            child: Container(
